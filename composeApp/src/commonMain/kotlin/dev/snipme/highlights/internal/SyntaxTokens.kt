...
internal object SyntaxTokens {
    ...
    val STEPS_KEYWORDS = setOf(
        "sys", "apps", "files", "flowname", "start", "homedir", "install", "pack", "log", "clear", "backup", "restore",
        "zip", "archive", "extract",
        "dtm", "now", "format",
        "csl", "error", "write", "read",
        "ref", "set", "name", "get", "del",
        "var", "set", "get", "del", "import", "export", "list",
        "lst", "new", "set", "get", "del", "len", "var", "import", "export",
        "stg", "set", "get", "del",
        "str", "cut", "add", "len", "get", "eqs", "split",
        "mat", "plus", "minus", "mult", "div", "eqs", "grtr", "less", "grtreqs", "lesseqs", "random", "int",
        "bln", "and", "or", "xor", "not",
        "fls", "read", "write", "del", "dir", "list", "xst",
        "scr", "new", "del", "set", "get", "nav", "page", "theme",
        "run", "one", "if", "while", "each", "for", "flow", "pause", "break", "stop",
        "srv", "new", "add", "run", "stop",
        "clt", "req",
        "tts", "say", "say2",
        "stt", "start", "stop", "wake", "unwake", "res", "lastres",
        "spr", "play",
        "llm", "ask"
    )
    ...
    val ALL_KEYWORDS = (C_KEYWORDS + CPP_KEYWORDS + JAVA_KEYWORDS + KOTLIN_KEYWORDS +
            ...
            TYPESCRIPT_KEYWORDS + STEPS_KEYWORDS).toSet()
