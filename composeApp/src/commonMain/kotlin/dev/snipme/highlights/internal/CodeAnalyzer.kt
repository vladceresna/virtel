...
import dev.snipme.highlights.internal.SyntaxTokens.STEPS_KEYWORDS
...
import dev.snipme.highlights.model.SyntaxLanguage.STEPS
...
internal object CodeAnalyzer {
    ...
    private fun analyzeForLanguage(code: String, language: SyntaxLanguage) =
        when (language) {
            ...
            STEPS -> analyzeCodeWithKeywords(code, STEPS_KEYWORDS)
            else -> analyzeCodeWithKeywords(code, ALL_KEYWORDS)
        }
